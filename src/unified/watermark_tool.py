...
class WatermarkTool:
    ...
    def __init__(self, config_path: Optional[str] = None):
        ...
        self.text_watermark = TextWatermark(config_path)
    ...
    def embed_image_watermark(self, image_input: Union[str, Image.Image], 
        ...
        """嵌入图像水印"""
        return self.image_watermark.embed_watermark(image_input, watermark_key, prompt)
    
    def extract_image_watermark(self, image_input: Union[str, Image.Image], 
                               watermark_key: str = None) -> Dict[str, Any]:
        """提取图像水印"""
        return self.image_watermark.extract_watermark(image_input, watermark_key)
    
    def generate_image_with_watermark(self, prompt: str, watermark_key: str = None) -> Image.Image:
        """生成带水印的图像"""
        return self.image_watermark.generate_with_watermark(prompt, watermark_key)
    ...
    def get_supported_algorithms(self) -> Dict[str, list]:
        ...
        return {
            ...
            'image': ['stable_signature']  # TODO: 添加更多图像算法
        }
...
def main():
    ...
    parser.add_argument("--key", default="default_key", help="Watermark key")
